# The source code of Submission 2200

## Preparation
1. Install the requirements in [requirements.txt](https://github.com/KDD2022-Submission2200/Code/blob/main/requirements.txt).
...
```
git clone https://github.com/KDD2022-Submission2200/Code.git
cd Code
mkdir output
```
